...
template<class T>
constexpr ReversedLazySeq<T>::ReversedLazySeq(const LazySeq<T> &reversedSeq, LazySeq<T> nonReversedSeq)
        : LazySeq<T>(reversedSeq), nonReversedSeq_(std::move(nonReversedSeq)) {}
